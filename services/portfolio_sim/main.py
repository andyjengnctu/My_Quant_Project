...
def main(argv=None, env=None):
    ...
    try:
        ...
        param_source_choice = safe_prompt_choice(
            "👉 參數來源：[Enter] Trade active (預設)  [C] candidate_best  [O] Rolling replay :  ",
            "R",
            ("R", "C", "O"),
            "參數來源",
        )
    ...
    print_strategy_dashboard(
        ...
        normal_trades=pf_profile.get("normal_trades", normal_trade_count), extended_trades=pf_profile.get("extended_trades", extended_trade_count),
