...
def _build_inception_spec(
    ...
    *,
    ...
    price_volume_local_map_history_bars = descriptor_options.get("price_volume_local_map_history_bars")
    price_volume_local_map_time_bins = descriptor_options.get("price_volume_local_map_time_bins")
    ...
    return BreakoutQualityModelSpec(
        ...
        price_volume_local_map_history_bars=(
            None if price_volume_local_map_history_bars is None else int(price_volume_local_map_history_bars)
        ),
        price_volume_local_map_time_bins=(
            None if price_volume_local_map_time_bins is None else int(price_volume_local_map_time_bins)
        ),
        price_volume_local_map_price_bins=(
            None if price_volume_local_map_price_bins is None else int(price_volume_local_map_price_bins)
        ),
        price_volume_local_map_price_span_atr=(
            None if price_volume_local_map_price_span_atr is None else float(price_volume_local_map_price_span_atr)
        ),
