...
_ARCHITECTURE_DESCRIPTORS = (
    ...
    _descriptor(GRU_SHARED_SAFETY_MFE_V1, active=True, active_order=25, spec_builder="gru_shared_safety_mfe", runtime_builder="gru_shared_safety_mfe", capabilities=("shared_safety_mfe", "gated_recurrent_state")),
