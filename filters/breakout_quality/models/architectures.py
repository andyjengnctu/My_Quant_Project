...
BIGRU_RANKER_V1 = "bigru_ranker_v1"
...
_ARCHITECTURE_DESCRIPTORS = (
    ...
    _descriptor(
        ...
        family="inception_time_shared_safety_dynamic_hypergraph_relation_change_mfe",
        pooling=(
            "global_average",
            "same_date_low_rank_dynamic_hypergraph_safety_residual",
            "previous_date_hyperedge_relation_change_safety_residual",
            "raw_safety_head",
            "raw_mfe_head",
        ),
        use_dataset_context=False,
        sequence_input_paths=(
            "raw_level",
            "same_date_cross_stock_latent_relations",
            "previous_trading_date_cross_stock_relation_change",
        ),
        head_width=None,
        same_date_hyperedge_count=16,
        same_date_relation_stop_gradient=True,
        same_date_relation_zero_init_residual=True,
        same_date_relation_history_steps=1,
    ),
    _descriptor(
        INCEPTION_TIME_SHARED_ADAPTIVE_HORIZON_SAFETY_MFE_V1,
        active=True,
        ...
        capabilities=(
            "shared_safety_mfe",
            "adaptive_horizon_safety",
        ),
        family="inception_time_shared_adaptive_horizon_safety_mfe",
        pooling=(
            "global_average",
            "adaptive_horizon_safety_trajectory",
            "adaptive_horizon_safety_residual",
            "raw_safety_head",
            "raw_mfe_head",
        ),
        use_dataset_context=False,
    ...
    _descriptor(
        ...
        family="inception_time_shared_safety_mfe_price_volume_multiscale",
        pooling=(
            "global_average",
            "safety_price_volume_structure_residual",
    ...
    _descriptor(
        ...
        capabilities=(
            "shared_safety_mfe",
            "safety_temporal_self_attention",
            "safety_pairwise_temporal_relation_bias",
        ),
        family="inception_time_shared_safety_pairwise_relation_mfe",
        pooling=(
        ...
        head_width=None,
        pairwise_temporal_relation_features=(
            "delta_log_close",
            "delta_log_high",
            "delta_log_low",
        ...
        pairwise_temporal_relation_hidden_dim=8,
    ),
    ...
    _descriptor(BIGRU_RANKER_V1, active=True, active_order=28, spec_builder="gru_shared_safety_mfe", runtime_builder="gru_shared_safety_mfe", capabilities=("gated_recurrent_state", "bidirectional_recurrent_state", "single_rank_head"), gru_hidden_size=274, gru_layers=1, gru_bidirectional=True),
