...
HELP_DESCRIPTION = "說明: 互動式 Smart Downloader：現行 Trading 更新、Market Data V2 Backer Preflight / Exact Planner、完整 Bootstrap 開始/續傳、Provider Snapshot 驗證，以及不使用 API quota 的 Full Database Integrity Audit；Research 資料不會被修改。"
