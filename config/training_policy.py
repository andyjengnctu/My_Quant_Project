...
OPTIMIZER_RANDOM_SEED_ENSEMBLE_SIZE = 4
# "auto" = 過半數；整數 = 至少幾個 seed 同意。解析後會 clamp 到 1~N，因此最大值永遠是 N。
OPTIMIZER_RANDOM_SEED_ENSEMBLE_MIN_AGREE = 4
...
# 選取邏輯：local_retention > 此值後，再依 base_rank 取第一名。
OPTIMIZER_BASE_RETENTION_GT_MIN = 0.5
