...
OPTIMIZER_LOCAL_MIN_SCORE_FINALIST_TOP_K = 5  # local_min_score finalist review 的 top-k 候選數

# optimizer 提供兩種資料區間模式：
# split = 固定 pre-deploy(2010~2019) 選參 + 固定 OOS(2020~latest) 驗證
# full  = 全資料選參；不額外切 OOS
DEFAULT_OPTIMIZER_MODEL_MODE = 'split'
PREDEPLOY_SELECTION_START_YEAR = 2019
OOS_EVALUATION_START_YEAR = 2025
...
def build_training_score_policy_snapshot():
    return {
        ...
        "OPTIMIZER_LOCAL_MIN_SCORE_FINALIST_TOP_K": OPTIMIZER_LOCAL_MIN_SCORE_FINALIST_TOP_K,
    }
