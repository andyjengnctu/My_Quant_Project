...
RUNTIME_PARAM_SPECS = {
    "optimizer_max_workers": {"type": int, "default": None, "allow_none": True, "min_value": 1},  # optimizer worker 數上限，預設 None
    "scanner_max_workers": {"type": int, "default": None, "allow_none": True, "min_value": 1},  # scanner worker 數上限，預設 None
    "scanner_live_capital": {"type": float, "default": 2_000_000.0, "allow_none": False, "min_value": 0.0},  # scanner 參考投入本金，預設 2,000,000.0
}
