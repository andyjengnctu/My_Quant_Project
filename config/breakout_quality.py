...
BREAKOUT_QUALITY_MODEL_TEST_REFERENCE_PROFILES = (
    ...
    ("MR-13AM", "daily_universal_shared_safety_weighted_full_horizon_opportunity_full_list_ndcg_pairwise"),
)
        ...
        if self.training_objective == TRAINING_OBJECTIVE_BINARY_CLASSIFICATION:
            ...
            if self.training_objective == TRAINING_OBJECTIVE_DAILY_DUAL_COMPONENT_R_REGRESSION:
                ...
                expected_epoch_metric = (
                    ...
                    if self.training_objective == TRAINING_OBJECTIVE_DAILY_SHARED_SAFETY_HS_CONDITIONAL_MFE_PAIRWISE_RANKING
                    else "hs_priority_mfe_mean_daily_spearman"
                    if self.training_objective == TRAINING_OBJECTIVE_DAILY_SHARED_SAFETY_HS_PRIORITY_MFE_PAIRWISE_RANKING
...
class ContinuousRankerResearchSpec:
    ...
    def __post_init__(self) -> None:
        ...
        if self.secondary_pair_scope == CONTINUOUS_RANKER_SECONDARY_PAIR_SCOPE_ALL:
            ...
            if profile.training_objective != TRAINING_OBJECTIVE_DAILY_SHARED_SAFETY_HS_CONDITIONAL_MFE_PAIRWISE_RANKING:
