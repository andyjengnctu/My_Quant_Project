...
BREAKOUT_QUALITY_MODEL_TEST_REFERENCE_PROFILES = (
    ...
    # BP returns to AO as the scientific base.  AY is the mechanistic control for
    # temporal self-attention without explicit pairwise market-relation features.
    ("MR-13AY", "daily_universal_shared_safety_self_attn_hs_conditional_mfe_full_list_ndcg_pairwise"),
)
