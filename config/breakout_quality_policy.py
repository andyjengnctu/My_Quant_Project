...
BREAKOUT_QUALITY_MODEL_ARCHITECTURE = "multiscale_cnn_v2"  # 模型架構；可設為 tiny_cnn_v1、multiscale_cnn_v1、multiscale_cnn_v2 或 residual_tcn_v1。v2 僅在模型內新增 Return／Delta 表示，不改 Dataset。
