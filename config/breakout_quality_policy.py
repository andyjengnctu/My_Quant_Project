...
BREAKOUT_QUALITY_FINAL_REFIT_MODE = "matched_optimizer_steps"  # Selection 重訓方式；matched_optimizer_steps 會匹配 best epoch 的 optimizer updates，selected_epochs 為舊式固定相同 epoch 數。
