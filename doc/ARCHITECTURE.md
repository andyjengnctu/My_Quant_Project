...
- Selection與Forward-OOS由兩個永久共存的Strategy Compare profiles隔離；current核心比較為Selection=`C32/C23/C42/C51`、Forward=`C1/C3/C44`；C51只屬Selection stage，未通過Selection策略Gate前不擴張Forward。Full只作DL-off完整策略體系baseline，Min ROOS作同param/rule baseline，MR-13E exact constrained作current DL allocator；其他已完成MR-12B/MR-13A/No-R0 controls全部只保留歷史重現。
