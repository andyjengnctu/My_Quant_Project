...
└─ tools/
   ...
   └─ validate/
      ...
      ├─ synthetic_strategy_cases.py    # synthetic 可隨策略升級調整案例：model I/O schema / ranking & scoring sanity / optimizer objective-export contract
