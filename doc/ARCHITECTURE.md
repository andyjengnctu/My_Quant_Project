...
└─ tools/
   ...
   └─ validate/
      ...
      ├─ synthetic_error_cases.py       # synthetic 錯誤路徑案例：params_io / module_loader / preflight fail-fast
      ...
      ├─ synthetic_strategy_cases.py    # synthetic 可隨策略升級調整案例：model I/O schema / ranking & scoring sanity
      ├─ synthetic_regression_cases.py  # synthetic 重跑/快取污染案例：scanner repeatability / optimizer raw cache rerun
