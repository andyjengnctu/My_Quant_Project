...
└─ tools/
   ...
   └─ validate/
      ...
      ├─ synthetic_meta_cases.py        # synthetic meta 案例：TEST_SUITE_CHECKLIST / GPT_DELIVERY_CHECKLIST / registry / synthetic 主入口一致性
