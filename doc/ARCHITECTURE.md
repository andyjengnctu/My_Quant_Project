...
- `core/exact_accounting.py`：正式 `cash/pnl/equity/reserved_cost/risk` 與 partial-exit cost-basis allocation 的精確整數帳務單一真理來源；`core/price_utils.py` 僅保留價格/tick/limit façade 與顯示相容 helper。
