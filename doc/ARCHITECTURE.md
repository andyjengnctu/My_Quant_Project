...
└─ tools/
   ...
   └─ validate/
      ...
      ├─ synthetic_meta_cases.py        # synthetic meta 案例：TEST_SUITE_CHECKLIST / registry / synthetic 主入口一致性（GPT checklist 不列入本地 formal 驗證）
