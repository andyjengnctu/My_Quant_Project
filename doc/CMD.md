...
# apps/ml_optimizer.py 為薄入口；tools/optimizer/main.py 負責 CLI/啟動，objective.py 負責 objective / filter rules，callbacks.py 負責 monitoring / 破紀錄展示，session.py 僅保留 session 狀態 façade，runtime.py 負責記憶庫流程/匯出
