...
| Current Selection strategy matrix | `SR-C32 / C23 / C25 / C28 / C35` | Current單seed策略Gate顯示`Full ROOS`、`Min ROOS`、`Min MR-12B`、`Min MR-13A`、`Min MR-13E`；三個DL arms固定相同historical Min params與feasible-ascent，只有score source不同。 | RESULT_AVAILABLE／MR13E_SELECTION_GATE_PASS／ROBUSTNESS_OFF。C25 12B=`101.55%/19.66%/RoMD 5.17/DL選擇R +26.19R`；C28 13A=`151.88%/18.86%/8.05/+109.91R`；C35 13E=`153.96%/19.88%/7.74/+35.96R`。13E相對12B Return `+52.41pp`、RoMD `+2.58`、DL選擇R `+9.77R`；相對13A Return僅`+2.08pp`但RoMD `-0.31`、EV `-0.17R`、DL選擇R `-73.96R`。C35仍維持`robustness_role=off`。 |
| Current Forward-OOS strategy matrix | `SR-C1 / C3 / C20 / C29 / C36` | Current單seed策略Gate顯示`Full ROOS`、`Min ROOS`、`Min MR-12B`、`Min MR-13A`、`Min MR-13E`；三個DL arms固定相同current Min params與feasible-ascent，只有score source不同。 | RESULT_AVAILABLE／MR13E_FORWARD_GATE_FAIL_VS_MR12B／ROBUSTNESS_OFF。C20 12B=`190.26%/18.75%/RoMD 10.15/EV 1.17R/DL選擇R +35.93R`；C29 13A=`83.81%/15.71%/5.34/0.52R/-183.42R`；C36 13E=`128.77%/17.18%/7.49/0.87R/-66.22R`。13E相對13A明顯改善，但相對12B Return `-61.49pp`、RoMD `-2.65`、EV `-0.30R`、DL選擇R `-102.16R`，故不promotion、不直接進8-seed。Read-only orderable/feasible Audit已顯示13E Forward raw orderable Top-N Lift=`1.0996R`勝12B=`0.8223R`；selector-stage Audit再定位Raw→minimum-repair為主損失（13E `-1.3763R` vs 12B `-0.9292R`），而ascent/action/fill差極小。下一步只做minimum-repair scalable search-certificate attribution。 |
