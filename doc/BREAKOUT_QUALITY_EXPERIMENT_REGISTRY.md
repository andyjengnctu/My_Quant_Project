...
| Current Forward-OOS strategy matrix | `SR-C1 / C3 / C20 / C29` | 核心四arm顯示名稱統一為`Full ROOS`、`Min ROOS`、`Min MR-12B`、`Min MR-13A`；Forward-OOS階段由profile頁首標示，MR-12B／MR-13A arms皆固定使用feasible-ascent，Full只作完整策略體系baseline，MR-13A改善研究聚焦同一Min universe下的純DL source contrast | IMPLEMENTED／RESULT_AVAILABLE／ITERATIVE_RESEARCH_OOS。共同期間=2021-01-01～2025-12-22。C1 Full=123.26%/17.41%/RoMD7.08/EV0.53R；C3 Min=86.21%/13.12%/6.57/0.91R；C20 Min+MR-12B=172.40%/18.75%/9.20/1.08R、selection R +40.61R；C29 Min+MR-13A=71.86%/15.71%/4.57/0.46R、selection R -163.52R。核心contrasts=`C1-C3`,`C20-C3`,`C29-C3`,`C29-C20`；C30/C31保留永久歷史結果但inactive，不再擴大current comparison。 |
...
| `DL-CONT13A` | `CONT13A` | `MR-13A / ARCH-inception_time_v1 / PROFILE-daily_universal_no_time_pairwise` | Frozen Forward-OOS daily continuous score；策略盤前使用最新已完成交易日score；current改善研究只在Min ROOS + frozen feasible-ascent下與`DL-CONT12B`做同universe純source比較 | RESULT_AVAILABLE／ITERATIVE_RESEARCH_ACTIVE／NOT_PROMOTED；Selection策略支持但Forward-OOS C29明顯落後C20，因此不得升級為正式anchor；可做新的MR-13* scientific experiment，但不得用2021～2025 OOS直接選loss weight／hyperparameter |
...
| `SR-C20` | Min ROOS: MR-12B max-DL feasible-ascent | current五欄Min ROOS、all-off rules、frozen feasible-ascent；K/R0與reserved-capital floor由同一Min DL-off baseline逐日建立；score source=`DL-CONT12B` | RESULT_AVAILABLE／CURRENT_FORWARD_ANCHOR；2021-01-01～2025-12-22 Return=172.40%、MDD=18.75%、RoMD=9.20、Annual=22.36%、EV=1.08R、same-param selection R=+40.61R；相對C3 Return +86.18pp、RoMD +2.63、EV +0.17R。Current MR-13A改善以C20作同universe comparator。 |
...
| `SR-C29` | Forward-OOS: Min ROOS + MR-13A daily feasible-ascent | current五欄Min ROOS、all-off rules、frozen feasible-ascent與daily information-date lookup；K/R0與reserved-capital floor由同一C3 Min DL-off baseline逐日建立；score source=`DL-CONT13A` | RESULT_AVAILABLE／ITERATIVE_RESEARCH_OOS_FAIL／ACTIVE_MR13A_CHALLENGER；2021-01-01～2025-12-22 Return=71.86%、MDD=15.71%、RoMD=4.57、Annual=11.52%、EV=0.46R、same-param selection R=-163.52R；C29-C20 source-only Return -100.54pp、RoMD -4.62、EV -0.62R、selection R -204.13R。保留為MR-13A改善對照，不得將本Forward期間拿來調selector或直接選超參數。 |
