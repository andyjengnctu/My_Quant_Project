...
| Latest cross-period robustness | `MR-13A` vs `MR-12B` / same generated 8 seeds | Selection PIT 2014-01-01～2020-12-31 vs Forward-OOS 2021-01-01～2026-03-02 | RESULT_AVAILABLE／CROSS_PERIOD_DIRECTION_REVERSAL。Selection PIT：MR-13A−MR-12B ΔDL選擇R Mean=`-20.76R`（3勝5敗）、ΔRoMD Mean=`-0.93`（2勝6敗）、方向一致=`7/8`；Forward：ΔDL選擇R Mean=`+50.64R`（6勝2敗）、ΔRoMD Mean=`+1.76`（4勝4敗）、方向一致=`4/8`。因此MR-13A relative edge沒有跨兩個時段穩定成立，current runtime anchor維持MR-12B；下一步先做read-only cross-period／year-regime attribution。 |
