...
| Current continuous DL anchor | `DL-CONT12B` | `MR-12B / ARCH-inception_time_v1 / PROFILE-strategy_aligned_no_time_all_event_pairwise` frozen OOS continuous score | SOURCE_SUPPORTED_FOR_MODEL_RESEARCH／CANONICAL_SEED42_FORWARD_ANCHOR／MULTI_SEED_SUPERIORITY_NOT_ESTABLISHED；future-independent Forward score重建後，seed 42的C20於2021-01-01～2026-03-02 Return=190.26%、MDD=18.75%、RoMD=10.15、EV=1.17R、same-param selection R=+35.93R；但2026-08-11首批8-seed robustness的MR-12B RoMD Mean/Median=`8.21/7.70`低於MR-13A的`9.97/10.87`。因此DL-CONT12B仍是目前canonical runtime anchor，但不再把seed 42的相對優勢視為跨seed模型優勢。 |
