...
| Current model research | `MR-13A` | Daily Universal No-time Pairwise Ranker / `daily_universal_no_time_pairwise`；保留all-stock daily universal方向，feature-eligible ticker/date皆可取得daily score；沿用300×10 sequence、InceptionTime、40-day adverse-first no-time opportunity-R、within-day RankNet與mean daily Spearman選epoch | RESULT_AVAILABLE／ITERATIVE_RESEARCH_ACTIVE／SELECTION_STRATEGY_PASS／FORWARD_OOS_STRATEGY_FAIL／NOT_PROMOTED。Selection current五欄Min ROOS下C28 Return=151.88%、MDD=18.86%、RoMD=8.05、EV=0.71R，C28-C25 source-only Return +50.33pp、RoMD +2.89、EV +0.19R、same-param selection R +83.72R。修正Forward score eligibility為feature-history-only後，2021-01-01～2026-03-02 current replay：C29 Return=83.81%、MDD=15.71%、RoMD=5.34、EV=0.52R；C29-C20純source Return -106.45pp、MDD -3.04pp、RoMD -4.81、EV -0.65R、same-param selection R -219.35R。故MR-13A Selection優勢未泛化到Forward策略層；不得再歸因於舊future-target coverage bug，也不得依Forward結果挑best seed或調hyperparameter。 |
...
| Current continuous DL anchor | `DL-CONT12B` | `MR-12B / ARCH-inception_time_v1 / PROFILE-strategy_aligned_no_time_all_event_pairwise` frozen OOS continuous score | SOURCE_SUPPORTED_FOR_MODEL_RESEARCH／CURRENT_FORWARD_STRATEGY_ANCHOR；future-independent Forward score重建後，C20於2021-01-01～2026-03-02 Return=190.26%、MDD=18.75%、RoMD=10.15、EV=1.17R、same-param selection R=+35.93R；相對C3 Return +88.66pp、RoMD +2.41、EV +0.15R。 |
