...
| T201 | `synthetic_registry_import_targets (run_quick_gate)` | B122 |
...
| 2026-04-08 | T201 | 新增 quick gate synthetic registry import target static check 並驗證 | NEW -> DONE | `synthetic_registry_import_targets (run_quick_gate)` |
