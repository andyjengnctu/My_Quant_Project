...
文件分工：`PROJECT_SETTINGS.md` 管原則；`GPT_DELIVERY_CHECKLIST.md` 管 GPT 交付前操作檢查；本檔管主表、狀態、測試入口與收斂索引。
