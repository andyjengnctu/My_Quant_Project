...
| 2026-04-07 | T183 | 新增細部交易契約承接 meta contract 並驗證 `L` / `P_fill` / 延續候選 barrier / inclusive hit 語意 | NEW -> DONE | `validate_project_settings_init_sl_frozen_plan_principle_case` |
