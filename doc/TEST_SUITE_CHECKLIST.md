...
| 2026-04-12 | T245 | 新增 PROJECT_SETTINGS checklist-sort / 一次找齊原則 exact contract 並驗證 | NEW -> DONE | `validate_project_settings_checklist_guard_and_exhaustive_inspection_case` |
