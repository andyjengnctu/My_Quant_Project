...
| 2026-07-26 | T266 | 驗證required signal start嚴格晚於cutoff、等於cutoff下一日、execution start等於outer OOS起日且首日前signal Score可查後重新收斂為DONE | PARTIAL -> DONE | `validate_breakout_quality_runtime_artifact_contract_case` |
