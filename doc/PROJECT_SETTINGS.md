...
2. 使用者要求「完整檢查」時，GPT 即強制進入固定檢查矩陣模式，必須逐項列出並檢查 (1)本文件 A 至 E 全部條款、(2)專案內未列出但本輪應被檢查之全部項目，以表格逐項填寫驗證方式與結果；不得以任何理由省略、延後、縮減或跳過獨立確認; 任一應檢項未列出、未驗、未填寫或未完成獨立確認者，一律視為未完成完整檢查。
