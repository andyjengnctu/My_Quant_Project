...
CORE_TRADING_COVERAGE_TARGETS = [
    ...
    "core/trading_lifecycle_plans.py",
    "core/trading_position_projection.py",
    ...
    "services/trading/live_reentry.py",
    "services/trading/strategy_param_runtime.py",
    "services/trading/scanner_state.py",
    "services/scanner/scan_runner.py",
    "services/trading/market_data_consumer.py",
    ...
    "services/trading/lifecycle_context.py",
    "services/trading/entry_lifecycle_context.py",
    "services/trading/signal_lineage.py",
    "services/trading/lifecycle_sync.py",
    "services/trading/pending_entry_service.py",
