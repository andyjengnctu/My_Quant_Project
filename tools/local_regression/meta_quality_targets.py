...
POLICY_CONTRACT_COVERAGE_TARGETS = [
    ...
    "core/market_data_dataset_registry.py",
    "core/market_data_bootstrap_planner.py",
    "core/market_data_bootstrap_requests.py",
    "core/market_data_execution_policy.py",
    "core/market_data_storage_policy.py",
    "core/market_data_storage_contract.py",
    "core/market_data_provider_snapshot.py",
    "core/market_data_trading_sync_policy.py",
    "core/market_data_trading_sync.py",
    "core/market_data_trading_storage_contract.py",
    ...
    "services/downloader/finmind_http.py",
    "services/downloader/market_data_preflight.py",
    ...
    "services/downloader/market_data_bootstrap_completion.py",
    "services/downloader/market_data_trading_sync.py",
