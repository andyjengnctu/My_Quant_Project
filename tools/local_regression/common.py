...
MANIFEST_DEFAULTS: Dict[str, Any] = {
    ...
    "performance_consistency_max_sec": 80,
    "performance_synthetic_case_max_sec": 15,
    "performance_chain_checks_max_sec": 60,
    "performance_ml_smoke_max_sec": 45,
    "performance_meta_quality_max_sec": 30,
    "performance_critical_path_max_sec": 110,
    "performance_optimizer_trial_avg_max_sec": 15,
    "performance_peak_process_memory_mb": 2048,
    "coverage_line_min_percent": 55,
...
MANIFEST_INT_FIELDS = {
    ...
    "performance_synthetic_case_max_sec",
    "performance_chain_checks_max_sec",
    "performance_ml_smoke_max_sec",
    "performance_meta_quality_max_sec",
    "performance_critical_path_max_sec",
    "performance_optimizer_trial_avg_max_sec",
    "performance_peak_process_memory_mb",
    "coverage_line_min_percent",
    "coverage_branch_min_percent",
    "coverage_critical_line_min_percent",
    "coverage_critical_branch_min_percent",
