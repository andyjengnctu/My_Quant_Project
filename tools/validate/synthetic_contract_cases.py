...
def validate_gui_trade_count_and_sidebar_sync_contract_case(base_params):
    ...
    add_check(results, "output_contract", case_id, "portfolio_marker_price_requires_recorded_execution_price", True, "return np.nan" in marker_price_block and '"Low"' not in marker_price_block and '"High"' not in marker_price_block and '"Close"' not in marker_price_block)
