...
def validate_gui_workbench_contract_case(base_params):
    ...
    run_bound_checks(
        ...
        (
            ...
            ('gui_data_ops_panel_uses_explicit_dataset_semantic_displays', True, 'latest_display' in data_ops_panel_source and 'expected_display' in data_ops_panel_source and 'next_check_display' in data_ops_panel_source,),
