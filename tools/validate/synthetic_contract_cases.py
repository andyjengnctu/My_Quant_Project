...
def validate_gui_chart_margin_and_latest_extended_preview_contract_case(base_params):
    ...
    check("extended_preview_limit_line_reaches_latest_actual_bar", True, bool(limit_line.size > 6 and np.isfinite(limit_line[6])))
    check("extended_preview_stop_line_uses_shadow_state_at_latest_actual_bar", True, bool(stop_line.size > 6 and np.isfinite(stop_line[6])))
    check("extended_preview_tp_line_uses_shadow_state_at_latest_actual_bar", True, bool(tp_line.size > 6 and np.isfinite(tp_line[6])))
