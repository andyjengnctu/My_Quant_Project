...
def validate_gui_workbench_contract_case(base_params):
    ...
    run_bound_checks(
        ...
        (
            ...
            ('gui_data_ops_panel_kpi_details_are_single_line', True, '_kpi_detail_vars["trading"].set(f"{target} | {strategy_id}")' in data_ops_panel_source and 'm | Task: {scheduler_status} | next {scheduler_next}' in data_ops_panel_source,),
            ('gui_data_ops_panel_has_trading_v2_and_quota_progress_same_row', True, 'text="Trading Ready"' in data_ops_panel_source and 'text="V2 Target Freshness"' in data_ops_panel_source and 'text="Last Observed Provider Quota"' in data_ops_panel_source and 'trading_readiness_box.grid(row=0, column=0' in data_ops_panel_source and 'readiness_box.grid(row=0, column=1' in data_ops_panel_source and 'quota_box.grid(row=0, column=2' in data_ops_panel_source,),
