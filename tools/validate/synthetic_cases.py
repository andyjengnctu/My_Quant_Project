...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_breakout_quality_policy_single_source_case, layer="core_invariant", cost_class="fast", impacted_modules=("config/breakout_policy.py", "config/breakout_quality_policy.py", "strategies/breakout/schema.py", "strategies/breakout/search_space.py", "filters/breakout_quality/contract.py", "filters/breakout_quality/features.py", "filters/breakout_quality/models/spec.py", "filters/breakout_quality/models/factory.py", "filters/breakout_quality/models/inception_time.py", "filters/breakout_quality/models/multiscale_cnn.py", "filters/breakout_quality/torch_runtime.py", "tools/filters/breakout_quality/common.py", "tools/filters/breakout_quality/build_dataset.py", "tools/filters/breakout_quality/train.py", "tools/filters/breakout_quality/export_scores.py", "tools/filters/breakout_quality/evaluate.py", "tools/filters/breakout_quality/report.py", "apps/breakout_quality.py")),
