...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_project_settings_init_sl_frozen_plan_principle_case, layer="meta_contract", cost_class="fast", impacted_modules=("doc/TEST_SUITE_CHECKLIST.md", "tools/validate/synthetic_meta_cases.py")),
