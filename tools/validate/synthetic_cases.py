...
from .synthetic_meta_cases import (
    validate_checklist_done_d_detail_resolved_case,
...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_checklist_done_d_detail_resolved_case, layer="meta_contract", cost_class="fast", impacted_modules=("doc/TEST_SUITE_CHECKLIST.md", "tools/local_regression/run_meta_quality.py")),
