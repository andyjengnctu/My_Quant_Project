...
from .synthetic_contract_cases import (
    ...
    validate_gui_portfolio_summary_readonly_text_contract_case,
...
_entry(validate_synthetic_case_chart_navigation_binder_import_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/validate/synthetic_meta_cases.py", "tools/validate/synthetic_contract_cases.py")),
        ...
        _entry(validate_gui_portfolio_summary_readonly_text_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/gui/portfolio_backtest_panel.py", "tools/validate/synthetic_contract_cases.py")),
