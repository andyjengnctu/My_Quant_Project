...
from .synthetic_meta_cases import (
    ...
    validate_architecture_models_champion_params_file_tree_sync_case,
...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_breakout_quality_policy_single_source_case, layer="core_invariant", cost_class="fast", impacted_modules=("config/breakout_policy.py", "config/breakout_quality_policy.py", "strategies/breakout/schema.py", "strategies/breakout/search_space.py", "filters/breakout_quality/contract.py", "filters/breakout_quality/features.py", "tools/filters/breakout_quality/common.py", "tools/filters/breakout_quality/build_dataset.py", "tools/filters/breakout_quality/export_scores.py")),
        ...
        _entry(validate_architecture_models_champion_params_file_tree_sync_case, layer="meta_contract", cost_class="fast", impacted_modules=("doc/ARCHITECTURE.md", "models/full_ensemble_base.json", "models/oos_ensemble_base.json", "models/roos_ensemble_base.json", "tools/validate/synthetic_meta_cases.py")),
