...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_optimizer_walk_forward_policy_contract_case, layer="strategy_contract", cost_class="fast", impacted_modules=("core/walk_forward_policy.py", "config/training_policy.py", "tools/optimizer/callbacks.py", "tools/optimizer/static_ensemble_dashboard.py", "tools/optimizer/outer_rolling_oos.py")),
