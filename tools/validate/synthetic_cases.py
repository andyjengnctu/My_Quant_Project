...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_breakout_quality_continuous_target_contract_case, layer="research_contract", cost_class="fast", impacted_modules=("filters/breakout_quality/continuous_target.py", "tools/filters/breakout_quality/audit_continuous_target.py", "apps/breakout_quality.py")),
