...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_synthetic_init_sl_single_source_runtime_case, layer="core_invariant", cost_class="fast", impacted_modules=("core/entry_plans.py", "core/extended_signals.py", "core/position_step.py", "core/price_utils.py", "tools/scanner/stock_processor.py", "tools/debug/entry_flow.py", "tools/debug/backtest.py")),
