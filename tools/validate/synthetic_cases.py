...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_project_settings_checklist_guard_and_exhaustive_inspection_case, layer="meta_contract", cost_class="fast", impacted_modules=("doc/PROJECT_SETTINGS.md", "apps/test_suite.py", "tools/validate/synthetic_meta_cases.py", "tools/validate/synthetic_cases.py")),
        _entry(validate_gpt_delivery_checklist_governance_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("doc/GPT_DELIVERY_CHECKLIST.md", "doc/PROJECT_SETTINGS.md", "doc/ARCHITECTURE.md", "doc/CMD.md", "apps/test_suite.py", "tools/validate/synthetic_meta_cases.py", "tools/validate/synthetic_cases.py")),
