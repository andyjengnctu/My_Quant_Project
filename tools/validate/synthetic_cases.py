...
from .synthetic_meta_cases import (
    ...
    validate_checklist_summary_section_headings_unique_case,
    ...
    validate_test_suite_help_text_has_no_stale_renamed_exact_contract_theme_case,
    ...
    validate_architecture_models_best_params_file_tree_sync_case,
    validate_architecture_helper_module_file_tree_sync_case,
    validate_architecture_support_module_file_tree_sync_case,
    ...
    validate_synthetic_contract_cases_project_root_path_helper_contract_case,
...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_checklist_summary_section_headings_unique_case, layer="meta_contract", cost_class="fast", impacted_modules=("doc/TEST_SUITE_CHECKLIST.md", "tools/local_regression/run_meta_quality.py", "tools/validate/synthetic_meta_cases.py")),
        ...
        _entry(validate_synthetic_case_non_error_initial_capital_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/validate/synthetic_meta_cases.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_synthetic_meta_cases_build_project_absolute_path_import_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/validate/synthetic_meta_cases.py", "tools/validate/module_loader.py")),
        _entry(validate_synthetic_case_normalize_chart_payload_literal_x_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/validate/synthetic_contract_cases.py", "tools/validate/synthetic_meta_cases.py")),
        ...
        _entry(validate_test_suite_summary_comment_covers_latest_exact_contract_ids_case, layer="meta_contract", cost_class="fast", impacted_modules=("apps/test_suite.py", "tools/validate/synthetic_cases.py", "tools/validate/synthetic_meta_cases.py")),
        _entry(validate_test_suite_help_text_mentions_latest_exact_contract_theme_case, layer="meta_contract", cost_class="fast", impacted_modules=("apps/test_suite.py", "tools/validate/synthetic_cases.py", "tools/validate/synthetic_meta_cases.py")),
        _entry(validate_test_suite_help_text_has_no_stale_renamed_exact_contract_theme_case, layer="meta_contract", cost_class="fast", impacted_modules=("apps/test_suite.py", "tools/validate/synthetic_cases.py", "tools/validate/synthetic_meta_cases.py")),
        ...
        _entry(validate_architecture_models_best_params_file_tree_sync_case, layer="meta_contract", cost_class="fast", impacted_modules=("doc/ARCHITECTURE.md", "models/all_best_params_1.json", "models/all_best_params_2.json", "models/all_best_params_3.json", "tools/validate/synthetic_meta_cases.py")),
        _entry(validate_architecture_helper_module_file_tree_sync_case, layer="meta_contract", cost_class="fast", impacted_modules=("doc/ARCHITECTURE.md", "core/model_paths.py", "core/output_paths.py", "tools/local_regression/meta_quality_coverage.py", "tools/local_regression/meta_quality_targets.py", "tools/trade_analysis/history_snapshot.py", "tools/validate/meta_contracts.py", "tools/validate/synthetic_display_cases.py", "tools/validate/synthetic_reporting_cases.py", "tools/validate/synthetic_meta_cases.py")),
        _entry(validate_architecture_support_module_file_tree_sync_case, layer="meta_contract", cost_class="fast", impacted_modules=("doc/ARCHITECTURE.md", "core/output_retention.py", "tools/local_regression/formal_pipeline.py", "tools/optimizer/runtime.py", "tools/optimizer/session.py", "tools/validate/synthetic_contract_cases.py", "tools/validate/synthetic_history_cases.py", "tools/validate/synthetic_guardrail_cases.py", "tools/validate/synthetic_regression_cases.py", "tools/validate/synthetic_portfolio_common.py", "tools/validate/synthetic_frame_utils.py", "tools/validate/synthetic_case_builders.py", "tools/validate/synthetic_meta_cases.py")),
        ...
        _entry(validate_synthetic_contract_cases_project_root_path_helper_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/validate/synthetic_contract_cases.py", "tools/validate/synthetic_meta_cases.py")),
        ...
        _entry(validate_project_settings_init_sl_frozen_plan_principle_case, layer="meta_contract", cost_class="fast", impacted_modules=("doc/PROJECT_SETTINGS.md", "tools/validate/synthetic_meta_cases.py")),
        _entry(validate_project_settings_checklist_guard_and_exhaustive_inspection_case, layer="meta_contract", cost_class="fast", impacted_modules=("doc/PROJECT_SETTINGS.md", "doc/TEST_SUITE_CHECKLIST.md", "apps/test_suite.py", "tools/validate/synthetic_meta_cases.py", "tools/validate/synthetic_cases.py")),
        ...
        _entry(validate_gui_workbench_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("apps/workbench.py", "tools/workbench_ui/main.py", "tools/workbench_ui/workbench.py", "tools/workbench_ui/single_stock_inspector.py", "tools/trade_analysis/trade_log.py")),
        ...
        _entry(validate_gui_trade_count_and_sidebar_sync_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/workbench_ui/single_stock_inspector.py", "tools/trade_analysis/charting.py", "tools/trade_analysis/backtest.py", "tools/trade_analysis/exit_flow.py", "tools/validate/synthetic_contract_cases.py")),
