...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_architecture_models_champion_params_file_tree_sync_case, layer="meta_contract", cost_class="fast", impacted_modules=("doc/ARCHITECTURE.md", "models/run_best_params.json", "tools/validate/synthetic_meta_cases.py")),
