...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_synthetic_param_guardrail_case, layer="core_invariant", cost_class="fast", impacted_modules=("core/strategy_params.py", "config/runtime_defaults.py", "tools/optimizer/objective_profiles.py")),
        ...
        _entry(validate_scanner_live_capital_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("core/capital_policy.py", "config/runtime_defaults.py", "core/price_utils.py", "tools/scanner/stock_processor.py")),
        ...
        _entry(validate_score_numerator_option_case, layer="strategy_contract", cost_class="fast", impacted_modules=("config/runtime_defaults.py", "core/portfolio_stats.py", "core/strategy_dashboard.py", "core/scanner_display.py")),
