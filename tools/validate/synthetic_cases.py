...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_breakout_quality_policy_single_source_case, layer="core_invariant", cost_class="fast", impacted_modules=("config/breakout_policy.py", "config/breakout_quality_policy.py", "config/breakout_quality_experiments.py", "strategies/breakout/schema.py", "strategies/breakout/search_space.py", "filters/breakout_quality/contract.py", "filters/breakout_quality/features.py", "filters/breakout_quality/models/spec.py", "filters/breakout_quality/models/factory.py", "filters/breakout_quality/models/inception_time.py", "filters/breakout_quality/mantis_contract.py", "filters/breakout_quality/mantis_pretrained.py",
            "filters/breakout_quality/models/mantis_v2.py", "filters/breakout_quality/models/modern_tcn.py", "filters/breakout_quality/models/multiscale_cnn.py", "filters/breakout_quality/models/ts2vec.py", "filters/breakout_quality/pretraining_store.py", "filters/breakout_quality/torch_runtime.py", "tools/filters/breakout_quality/common.py", "tools/filters/breakout_quality/build_dataset.py", "tools/filters/breakout_quality/build_pretraining_dataset.py", "tools/filters/breakout_quality/pretrain.py", "tools/filters/breakout_quality/train.py", "tools/filters/breakout_quality/export_scores.py", "tools/filters/breakout_quality/evaluate.py", "tools/filters/breakout_quality/report.py", "apps/breakout_quality.py")),
        ...
        _entry(validate_breakout_quality_runtime_artifact_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("filters/breakout_quality/artifacts.py", "filters/breakout_quality/mantis_contract.py", "filters/breakout_quality/mantis_pretrained.py",
            "filters/breakout_quality/models/mantis_v2.py", "filters/breakout_quality/paths.py", "filters/breakout_quality/pretraining_store.py", "filters/breakout_quality/runtime.py", "filters/breakout_quality/score_store.py", "filters/breakout_quality/inference.py", "tools/filters/breakout_quality/pretrain.py", "tools/filters/breakout_quality/train.py", "tools/filters/breakout_quality/export_scores.py", "tools/filters/breakout_quality/evaluate.py", "tools/filters/breakout_quality/report.py", "core/signal_utils.py")),
        ...
        _entry(validate_dataset_cli_contract_case, layer="cli_contract", cost_class="fast", impacted_modules=("apps/breakout_quality.py", "filters/breakout_quality/mantis_contract.py", "filters/breakout_quality/mantis_pretrained.py",
            "filters/breakout_quality/models/mantis_v2.py", "tools/filters/breakout_quality/pretrain.py", "tools/validate/cli.py", "tools/validate/synthetic_cli_cases.py")),
