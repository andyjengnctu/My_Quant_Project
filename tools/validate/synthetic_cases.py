...
from .synthetic_meta_cases import (
    ...
    validate_gui_mouse_navigation_validator_avoids_legacy_footer_hint_contract_case,
...
from .synthetic_contract_cases import (
    ...
    validate_gui_sidebar_line_values_and_portfolio_progress_contract_case,
    validate_gui_compact_header_and_portfolio_summary_contract_case,
    validate_gui_portfolio_summary_semantic_color_contract_case,
    validate_gui_portfolio_summary_platform_renderer_contract_case,
...
_entry(validate_synthetic_case_chart_navigation_binder_import_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/validate/synthetic_meta_cases.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_mouse_navigation_validator_avoids_legacy_footer_hint_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/validate/synthetic_meta_cases.py", "tools/validate/synthetic_contract_cases.py")),
        ...
        _entry(validate_gui_portfolio_tab_and_htmlless_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/gui/workbench.py", "tools/gui/portfolio_backtest_panel.py", "tools/gui/single_stock_inspector.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_sidebar_line_values_and_portfolio_progress_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/gui/single_stock_inspector.py", "tools/gui/portfolio_backtest_panel.py", "tools/debug/charting.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_compact_header_and_portfolio_summary_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/gui/single_stock_inspector.py", "tools/gui/portfolio_backtest_panel.py", "tools/debug/charting.py", "tools/portfolio_sim/simulation_runner.py", "core/portfolio_engine.py", "core/strategy_dashboard.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_portfolio_summary_semantic_color_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/gui/portfolio_backtest_panel.py", "core/strategy_dashboard.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_portfolio_summary_platform_renderer_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/gui/portfolio_backtest_panel.py", "tools/validate/synthetic_contract_cases.py")),
