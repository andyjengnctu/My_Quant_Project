...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_project_settings_checklist_guard_and_exhaustive_inspection_case, layer="meta_contract", cost_class="fast", impacted_modules=("doc/PROJECT_SETTINGS.md", "doc/GPT_DELIVERY_CHECKLIST.md", "doc/TEST_SUITE_CHECKLIST.md", "apps/test_suite.py", "tools/validate/synthetic_meta_cases.py", "tools/validate/synthetic_cases.py")),
