...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_trade_analysis_canonical_alias_export_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/trade_analysis/__init__.py", "tools/trade_analysis/trade_log.py")),
