...
from .synthetic_meta_cases import (
    ...
    validate_test_suite_help_text_has_no_stale_wording_or_bare_term_case,
...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_test_suite_help_text_has_no_stale_wording_or_bare_term_case, layer="meta_contract", cost_class="fast", impacted_modules=("apps/test_suite.py", "tools/validate/synthetic_cases.py", "tools/validate/synthetic_meta_cases.py")),
