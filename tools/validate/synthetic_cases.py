...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_synthetic_fill_below_limit_based_sizing_stop_still_enters_case, layer="core_invariant", cost_class="fast", impacted_modules=("core/entry_plans.py", "tools/debug/entry_flow.py")),
        ...
        _entry(validate_exact_accounting_display_leg_reconciliation_case, layer="unit_boundary", cost_class="fast", impacted_modules=("core/exact_accounting.py", "core/portfolio_exits.py", "tools/debug/exit_flow.py")),
        ...
        _entry(validate_gui_buy_signal_annotation_helper_import_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/debug/backtest.py", "tools/validate/synthetic_contract_cases.py", "tools/validate/synthetic_meta_cases.py")),
        ...
        _entry(validate_single_backtest_exact_cash_path_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("core/backtest_core.py", "core/backtest_finalize.py", "tools/debug/backtest.py", "tools/debug/exit_flow.py", "tools/validate/synthetic_meta_cases.py")),
        _entry(validate_debug_backtest_entry_cash_path_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/debug/backtest.py", "tools/debug/entry_flow.py", "tools/validate/synthetic_meta_cases.py")),
        _entry(validate_display_money_rounding_helper_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("core/exact_accounting.py", "core/portfolio_exits.py", "tools/debug/log_rows.py", "tools/validate/synthetic_meta_cases.py")),
        ...
        _entry(validate_debug_forced_closeout_exact_total_pnl_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/debug/exit_flow.py", "tools/validate/synthetic_meta_cases.py")),
        ...
        _entry(validate_debug_exit_display_capital_uses_ledger_totals_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/debug/exit_flow.py", "core/exact_accounting.py", "tools/validate/synthetic_meta_cases.py")),
        _entry(validate_debug_entry_display_capital_uses_exact_total_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/debug/entry_flow.py", "core/exact_accounting.py", "tools/validate/synthetic_meta_cases.py")),
        _entry(validate_debug_exit_entry_capital_fallback_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/debug/exit_flow.py", "core/exact_accounting.py", "tools/validate/synthetic_meta_cases.py")),
        _entry(validate_debug_half_exit_leg_return_pct_uses_allocated_cost_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/debug/exit_flow.py", "core/exact_accounting.py", "tools/validate/synthetic_meta_cases.py")),
        _entry(validate_debug_sell_signal_profit_pct_uses_exact_mark_to_market_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/debug/backtest.py", "core/exact_accounting.py", "tools/validate/synthetic_meta_cases.py")),
        _entry(validate_debug_exact_fallback_helpers_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/debug/backtest.py", "tools/debug/exit_flow.py", "core/exact_accounting.py", "tools/validate/synthetic_meta_cases.py")),
        _entry(validate_average_price_total_helper_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("core/exact_accounting.py", "core/price_utils.py", "tools/debug/backtest.py", "tools/debug/exit_flow.py", "tools/validate/synthetic_meta_cases.py")),
        ...
        _entry(validate_exact_ledger_return_ratio_no_money_float_division_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/debug/backtest.py", "tools/debug/exit_flow.py", "core/portfolio_exits.py", "tools/validate/synthetic_meta_cases.py")),
        ...
        _entry(validate_debug_exit_total_return_milli_binding_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/debug/exit_flow.py", "tools/validate/synthetic_cases.py", "tools/validate/synthetic_meta_cases.py")),
        ...
        _entry(validate_debug_backtest_history_snapshot_patch_seam_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/debug/backtest.py", "tools/validate/synthetic_meta_cases.py", "tools/validate/synthetic_contract_cases.py")),
        ...
        _entry(validate_specific_pass_only_exception_traceability_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("core/runtime_utils.py", "tools/debug/charting.py", "tools/validate/synthetic_meta_cases.py")),
        _entry(validate_broad_exception_traceability_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/debug/charting.py", "tools/gui/single_stock_inspector.py", "tools/validate/synthetic_meta_cases.py")),
        _entry(validate_gui_tcl_fallback_traceability_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/gui/workbench.py", "tools/validate/synthetic_meta_cases.py")),
        _entry(validate_optional_dependency_fallback_traceability_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("tools/debug/charting.py", "tools/downloader/runtime.py", "tools/gui/single_stock_inspector.py", "tools/validate/main.py")),
        ...
        _entry(validate_debug_empty_price_df_chart_payload_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/debug/reporting.py", "tools/validate/synthetic_contract_cases.py")),
        ...
        _entry(validate_record_signal_annotation_meta_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/debug/charting.py", "tools/validate/synthetic_contract_cases.py")),
        ...
        _entry(validate_workbench_theme_accent_symbol_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/gui/workbench.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_scanner_console_and_latest_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/gui/single_stock_inspector.py", "tools/debug/charting.py", "tools/scanner/scan_runner.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_sidebar_latest_preview_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/gui/single_stock_inspector.py", "tools/debug/charting.py", "tools/debug/backtest.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_single_stock_refined_visual_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/gui/single_stock_inspector.py", "tools/gui/workbench.py", "tools/debug/charting.py", "tools/debug/entry_flow.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_extended_preview_continuity_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/gui/single_stock_inspector.py", "tools/debug/entry_flow.py", "tools/debug/backtest.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_chart_margin_and_latest_extended_preview_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/debug/charting.py", "tools/debug/backtest.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_signal_annotation_and_forced_close_visual_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/debug/charting.py", "tools/debug/backtest.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_buy_signal_annotation_anchor_price_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/debug/backtest.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_trade_marker_and_tp_visual_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/debug/charting.py", "tools/debug/backtest.py", "tools/debug/exit_flow.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_trade_count_and_sidebar_sync_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/gui/single_stock_inspector.py", "tools/debug/charting.py", "tools/debug/backtest.py", "tools/debug/exit_flow.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_trade_box_capital_and_round_trip_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/debug/trade_log.py", "tools/debug/backtest.py", "tools/debug/charting.py", "tools/debug/exit_flow.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_latest_raw_signal_preview_helper_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/debug/backtest.py", "tools/validate/synthetic_contract_cases.py")),
        _entry(validate_gui_chart_overlay_layout_and_pan_contract_case, layer="output_contract", cost_class="fast", impacted_modules=("tools/gui/workbench.py", "tools/gui/single_stock_inspector.py", "tools/debug/charting.py", "tools/validate/synthetic_contract_cases.py")),
