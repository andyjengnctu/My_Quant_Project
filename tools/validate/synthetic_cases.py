...
def get_synthetic_validator_entries():
    return [
        ...
        _entry(validate_price_utils_array_tick_normalization_contract_case, layer="meta_contract", cost_class="fast", impacted_modules=("core/price_utils.py", "core/signal_utils.py", "tools/validate/synthetic_meta_cases.py")),
