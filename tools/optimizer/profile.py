...
PROFILE_FIELDS = [
    ...
    "prep_worker_run_backtest_sum_sec", "prep_worker_to_dict_sum_sec",
    "prep_static_pack_sec", "prep_executor_setup_sec", "prep_executor_submit_sec",
    "prep_executor_collect_sec", "prep_executor_shutdown_sec", "prep_merge_sum_sec",
    "prep_master_union_sec", "prep_feature_bank_hits", "prep_feature_bank_misses",
    "prep_feature_bank_size_max", "prep_feature_bank_max_items", "prep_ok_count",
    ...
    "full_month_count", "min_month_return_pct",
...
class OptimizerProfileRecorder:
    ...
    def build_summary_payload(self):
        ...
        numeric_fields = [
            ...
            "prep_worker_to_dict_sum_sec", "prep_static_pack_sec", "prep_executor_setup_sec",
            "prep_executor_submit_sec", "prep_executor_collect_sec", "prep_executor_shutdown_sec",
            "prep_merge_sum_sec", "prep_master_union_sec", "prep_feature_bank_hits",
            "prep_feature_bank_misses", "prep_feature_bank_size_max", "prep_feature_bank_max_items",
            "prep_avg_per_ok_sec", "sort_dates_sec",
