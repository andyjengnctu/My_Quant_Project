...
class V16StrategyParams:
    ...
    use_ema_pullback: bool = BREAKOUT_PARAM_SPECS["use_ema_pullback"]["default"]
    ema_pullback_short_len: int = BREAKOUT_PARAM_SPECS["ema_pullback_short_len"]["default"]
    ema_pullback_long_len: int = BREAKOUT_PARAM_SPECS["ema_pullback_long_len"]["default"]
    ema_pullback_long_slope_min_pct: float = BREAKOUT_PARAM_SPECS["ema_pullback_long_slope_min_pct"]["default"]
