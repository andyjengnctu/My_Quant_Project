...
def _build_closed_trade_stat(position, *, ticker, pnl, r_mult, exit_date, exit_price=None, exit_type=None):
    ...
    return {
        ...
        'breakout_quality_score': position.get('breakout_quality_score'),
        'breakout_quality_score_date': _format_date_or_none(position.get('breakout_quality_score_date')),
        'use_breakout_quality_ranking': bool(position.get('use_breakout_quality_ranking', False)),
