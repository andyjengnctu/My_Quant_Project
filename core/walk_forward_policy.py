...
def _normalize_objective_mode(objective_mode: str, default_objective_mode: str = "split_train_romd") -> str:
...
def build_walk_forward_policy_effective_snapshot(policy: Mapping[str, object]) -> dict:
    return {
        ...
        "objective_mode": _normalize_objective_mode(policy.get("objective_mode"), "split_train_romd"),
