...
The scientific/profile configuration owner resolves experiment identity.  The core runtime
module owns capability contracts and builders.  Keeping this forwarding gateway separate
prevents ``config.breakout_quality`` and ``core.breakout_quality_runtime`` from importing
