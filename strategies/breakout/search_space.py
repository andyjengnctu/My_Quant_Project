...
BREAKOUT_OPTIMIZER_SEARCH_SPACE = {
    ...
    "use_history_threshold": {"kind": "categorical", "choices": [True, False]},  # (AI註: 歷史門檻開關搜尋)
    ...
    "breakout_reclaim_window_bars": {"kind": "int", "low": 3, "high": 60, "step": 5, "enabled_by": "use_breakout_reclaim_reentry"},  # (AI註: re-entry 觀察窗搜尋)
    ...
    "min_history_win_rate": {"kind": "float", "low": 0.4, "high": 0.80, "step": 0.05, "enabled_by": "use_history_threshold"},  # (AI註: 歷史績效最小勝率門檻搜尋)
}
