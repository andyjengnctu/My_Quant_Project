...
BREAKOUT_OPTIMIZER_SEARCH_SPACE = {
    ...
    "use_kc": {"kind": "categorical", "choices": [True],},  # (AI註: 肯特納通道濾網開關搜尋)
    ...
    "min_history_ev": {"kind": "float", "low": 0.5, "high": 0.5, "step": 0.1},  # (AI註: 歷史績效最小期望值搜尋，預設區間 -1.0~0.5)
    "min_history_win_rate": {"kind": "float", "low": 0.0, "high": 0.0, "step": 0.05},  # (AI註: 歷史績效最小勝率搜尋，預設區間 0.0~0.6)
}
