...
BREAKOUT_OPTIMIZER_SEARCH_SPACE = {
    ...
    "use_history_threshold": {"kind": "categorical", "choices": [True]},  # (AI註: 歷史門檻開關搜尋)
    ...
    "min_history_win_rate": {"kind": "float", "low": 0.0, "high": 0.65, "step": 0.05, "enabled_by": "use_history_threshold"},  # (AI註: 歷史績效最小勝率門檻搜尋)
}
